...
@class RBKLivenessViewController;
@class NSNumber;

SWIFT_CLASS_NAMED("RBKLivenessActionsSetter")
@interface RBKLivenessActionsSetter : NSObject
+ (void)setActionsTo:(RBKLivenessViewController * _Nonnull)controller byValues:(NSArray<NSNumber *> * _Nonnull)values;
+ (void)setGeneratedActionsTo:(RBKLivenessViewController * _Nonnull)controller;
...
SWIFT_CLASS("_TtC11RBKLiveness22RBKLivenessApplication")
@interface RBKLivenessApplication : NSObject
+ (void)registerWithCompletion:(void (^ _Nullable)(BOOL))completion;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
